...
import static org.ChemaRamirez.conexion.Conexion.getConexion;
    ...
    public List<Estudiante> listarEstudiantes(){
        ...
        try {
            ...
            try {
                ...
                System.out.println("Ocurrio un rror al cerrar conexion: " + e.getMessage());
            }
        }
        return estudiantes;
    }
...
return false;
    ...
    public static void main(String[] args) {
        ...
        //Agregar estudiante
        var nuevoEstudiante = new Estudiante("Carlos", "Lara", "56345654", "carlos@mail.com");
        ...
        var estudianteModificar = new Estudiante(1, "Juan Carlos", "Rodriguez", "56354654", "juancarlos@mail.com");
